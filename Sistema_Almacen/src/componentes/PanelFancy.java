...
//import FancyBorderRadius.FancyAnimation;
//import FancyBorderRadius.FancyBorderRadius;
import com.xgilmar.util.FancyAnimation;
import com.xgilmar.util.FancyBorderRadius;
...
public class PanelFancy extends JComponent {
    ...
    public PanelFancy() {
        image = new ImageIcon(getClass().getResource("/img/miLogoTwo.png"));
        init();
    }
