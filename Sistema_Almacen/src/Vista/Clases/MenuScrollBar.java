 ...
 * @author Abraham
 */
public class MenuScrollBar extends BasicScrollBarUI {

    private final int THUMB_WIDTH = 8; // Ancho de la barra de desplazamiento ajustado
    private final Color THUMB_COLOR = new Color(139, 143, 156); // Color del thumb
    private final Color TRACK_COLOR = new Color(255, 255, 255); // Color del track
