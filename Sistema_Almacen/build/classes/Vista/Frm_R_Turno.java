...
public class Frm_R_Turno extends javax.swing.JFrame {
  ...
  Controlador.ControladorTurno turnos=new ControladorTurno(this);
    ...
    private void initComponents() {
        ...
        txtCodigoTurno = new componentes.TextFieldShadown();
        ...
        jpanelRound1.add(txtCodigoTurno, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 420, -1));
        ...
        jpanelRound1.add(txtNombreTurno, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 420, -1));
...
return txtCodigoTurno.getText().trim();
}

public String getNombreTurno(){
return txtNombreTurno.getText().trim();
}

public String getHoraInicialTurno(){
return txtHoraFinalTurno.getText().trim();
}
...
return txtHoraFinalTurno.getText().trim();
    ...
    private componentes.TextFieldShadown txtHoraFinalTurno;
    private componentes.TextFieldShadown txtHoraInicialTurno;
    private componentes.TextFieldShadown txtNombreTurno;
